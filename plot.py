...
print("Loading data")
data_time_aws, data_cpu_aws, data_mem_aws, data_diskRand_aws, data_diskSeq_aws = np.loadtxt('results-aws.csv', delimiter=',', unpack=True, skiprows=1)
parsed_time_aws = convert_time(data_time_aws)
data_time_gcp, data_cpu_gcp, data_mem_gcp, data_diskRand_gcp, data_diskSeq_gcp = np.loadtxt('results-gcp.csv', delimiter=',', unpack=True, skiprows=1)
